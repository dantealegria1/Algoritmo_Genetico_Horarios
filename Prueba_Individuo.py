...
Modulo1 = np.array(["LC1-1", "FEC-2", "CD-3", "AS-4", "CB-5", "LC3-6", "ECA-7", "IA-8",
                    "AL-9", "EDP-10", "RB-11", "OI-12", "AU-13", "AID-14", "LI-15", "BD-17", "AU2-18", "DMD-19",
                    "MH-20", "ESI-21", "PI-22", "LE-23", "RE1-24", "TSI-25", "SI1-26", "SW-27", "PA-28", "SIS-29", "MD-30"])
...
Modulo7 = np.array(["Aula", "Lab", "Salon"])
Modulo8 = np.array(["54 A", "54 C", "54 F", "54 G", "54 H", "61 LAB", "203 LAB", "204 LAB", "1 AUD"])
Modulo9 = 0
